...
function TeamCta() {
    return (
        <div className="font-montserrat flex flex-col gap-[30px] items-center text-center py-20 px-4">
            <h2 className='font-bold text-[#252B42] text-[40px]'>Start your<br className='block md:hidden'/> 14 days free trial</h2>
