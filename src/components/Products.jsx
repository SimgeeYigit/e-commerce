...
function Products() {
    ...
    return (
        <div className="pb-20 md:pb-0 flex flex-col md:mx-[9.876rem] mx-0 gap-6 md:gap-0">
            <div className="flex flex-col justify-center items-center gap-2.5 py-12 md:py-8 px-10 text-center">
                <h4 className="font-montserrat font-normal text-[#737373] text-xl hidden md:block">Featured Products</h4>
