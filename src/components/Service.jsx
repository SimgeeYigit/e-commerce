...
function Service() {
    return (
        <div className='flex flex-col mx-0 md:mx-[9.876rem] py-20 gap-y-20'>
            <div className="flex flex-col justify-center items-center gap-2.5">
                ...
                <p className="font-montserrat font-normal text-[#737373] text-sm text-center">Problems trying to resolve the conflict <br className="block md:hidden" />between</p>
            </div>
            <div className='flex flex-col justify-around md:flex-row'>
                <div className='flex flex-col items-center w-full md:w-[33%] py-[2.1875rem] px-10 gap-y-5'>
