function AboutContent() {
    return (
        <div className="font-montserrat py-6 px-[150px]">
            <p className="font-normal text-sm text-[#E74040] mb-6">Problems trying</p>
            <div className="flex gap-[75px] items-baseline justify-between">
