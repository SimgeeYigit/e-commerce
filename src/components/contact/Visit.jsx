...
function Visit() {
    return (
        <>
            <div className="flex flex-col w-auto h-[814px] py-[112px] gap-20 font-montserrat">
                <div className="flex flex-col items-center gap-[10px]">
                    <h6 className="font-bold text-sm text-[#252B42]">VISIT OUR OFFICE</h6>
                    <h2 className="font-bold text-[40px] text-[#252B42] text-center">We help small businesses<br />
                        with big ideas</h2>
                </div>
                <div className="flex justify-center">
                    <div className="flex flex-col py-[50px] px-[40px] gap-[15px] items-center justify-center">
                        ...
                        <button
                            className="rounded-[37px] border border-[#23A6F0] text-[#23A6F0] font-bold text-sm py-[15px] px-9"
                        >Submit Request</button>
                    </div>
                    <div className="flex flex-col py-[50px] px-[40px] gap-[15px] items-center justify-center w-[328px] h-[403px] bg-[#252B42]">
            ...
            <div className="flex flex-col items-center justify-center gap-4 pb-20 font-montserrat">
