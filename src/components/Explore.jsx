...
function Explore() {
    return (
        <div className="flex flex-col mx-[128px] gap-4 my-20 justify-center md:flex-row">
            <div>
                <div className="w-[611px] h-[572px] flex flex-col justify-end bg-cover bg-center bg-mobile-explore-1 md:bg-explore-1">
            ...
            <div className="flex flex-col gap-[1.375rem]">
                <div className="w-[21.625rem] h-[24.875rem] flex flex-col justify-end bg-cover bg-center bg-mobile-explore-2 md:bg-explore-2 md:w-[34.8125rem] md:h-[18.0625rem]"
                    >
                    <div className="bg-[#2D8BC0BF] w-[21.625rem] h-[10.8125rem] flex flex-col gap-5 pl-9 pt-10">
                        <h4 className="text-[#FFFFFF] font-montserrat font-normal text-xl">Top Product Of The Week</h4>
                        <button className="text-[#FFFFFF] font-bold text-sm py-[15px] px-10 border rounded-[5px] border-[#FFFFFF] w-[198px] h-[52px]">EXPLORE ITEMS</button>
                    </div>
                </div>

                <div className="w-[34.8125rem] h-[16.3125rem] flex flex-col justify-end bg-cover bg-center bg-mobile-explore-3 md:bg-explore-3"
                    >
